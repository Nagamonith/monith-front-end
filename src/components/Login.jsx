...
export default function Login() {
    ...
    return (
        <div className="flex flex-row items-center justify-between h-screen bg-no-repeat bg-login-signup">
            <div>
                <h1>.</h1>
            </div>
            <div className="flex flex-col items-center justify-between h-screen w-[36rem] px-14 bg-[#D9D9D9]">
