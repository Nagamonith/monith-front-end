        ...
        <div className="flex flex-row hw:flex-col st:mb-3">
          ...
          <div className="border border-black border-opacity-50 h-full min-w-[300px] self-center rounded-lg flex flex-col ml-5 hw:w-full hw:mx-4 hw:mt-2">
            ...
            <ul className="pl-3 hw:pb-5 mt-4 font-Outfit-Regular">
              ...
              <li className={`p-3 ${seatSelected < studentsCount && seatSelected !== 0 ? "text-red-500" : ""} ${seatSelected < studentsCount || seatSelected === 0 ? "" : "text-green-save"} `}>Rooms Selected : {bookedRooms.length > 0 ? bookedRooms.length : selectedRooms.length}</li>
              <li className={`p-3 ${seatSelected < studentsCount && seatSelected !== 0 ? "text-red-500" : ""} ${seatSelected < studentsCount || seatSelected === 0 ? "" : "text-green-save"} `}>Seats Selected : {seatSelected} </li>
      ...
      <div className="px-8 py-4 my-2">
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="flex flex-row gap-10">
            <button className="bg-green-500 hover:bg-green-400 text-white font-Outfit-Bold h-10 w-[10rem] rounded-[20px]" type="button" onClick={handleRooms} hidden={seatSelected < studentsCount || seatSelected === 0}>ARRANGE</button>
